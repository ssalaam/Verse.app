...
public class EditLineActivity extends IcePickActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        gs = new GestureDetector(EditLineActivity.this, new EditLineActivity.GestureListener());


        record_button.setImageDrawable(getResources().getDrawable(R.drawable.mic_svg));

        outputFile = MyApplication.current_file.filename;
        ((EditText)findViewById(R.id.lineedittext)).setText(MyApplication.current_file.text);
                ...
                if (can_record) {
                    ...
                    if (action == MotionEvent.ACTION_DOWN) {
                        ...
                        if (isRecording) {
                            ...
                            record_button.setImageDrawable(new IconicsDrawable(EditLineActivity.this)
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_edit_line_activity, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_save ) {
            ...
            MyApplication.current_file.text = ((EditText)findViewById(R.id.lineedittext)).getText().toString();
            DatabaseHandler.getInstance(EditLineActivity.this).updateLineText(MyApplication.current_file.filename,((EditText)findViewById(R.id.lineedittext)).getText().toString());
            saved = true;
            setResult(RESULT_OK);
            finish();
            return true;
