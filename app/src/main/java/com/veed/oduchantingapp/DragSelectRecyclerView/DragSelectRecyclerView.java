package com.veed.oduchantingapp.DragSelectRecyclerView;
 ...
 */
public class DragSelectRecyclerView extends UltimateRecyclerView {
    ...
    private int getItemPosition(MotionEvent e) {
        final View v = mRecyclerView.findChildViewUnder(e.getX(), e.getY());
        if (v == null) return -2;
        if (v.getTag() == null || !(v.getTag() instanceof RecyclerView.ViewHolder))
            throw new IllegalStateException("Make sure your adapter makes a call to super.onBindViewHolder(), and doesn't override itemView tags.");
        final RecyclerView.ViewHolder holder = (RecyclerView.ViewHolder) v.getTag();
